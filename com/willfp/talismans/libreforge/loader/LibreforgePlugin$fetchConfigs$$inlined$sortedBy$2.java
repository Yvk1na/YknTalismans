...
public final class LibreforgePlugin$fetchConfigs$$inlined$sortedBy$2<T> implements Comparator {
   @Override
   public final int compare(T a, T b) {
      RegistrableConfig it = (RegistrableConfig)a;
      int var4/* $VF was: $i$a$-sortedBy-LibreforgePlugin$fetchConfigs$3 */ = 0;
      Comparable var10000 = it.getConfig().getInt("load-weight", 100);
      it = (RegistrableConfig)b;
      Comparable var5 = var10000;
      var4/* $VF was: $i$a$-sortedBy-LibreforgePlugin$fetchConfigs$3 */ = 0;
      return ComparisonsKt.compareValues(var5, it.getConfig().getInt("load-weight", 100));
   }
}
