...
@Metadata(
   ...
   d2 = {
         "Lcom/willfp/talismans/libreforge/loader/internal/InvalidLibreforgePluginError;",
         "Ljava/lang/Error;",
...
public final class InvalidLibreforgePluginError extends Error {
   @NotNull
   private final String message;

   public InvalidLibreforgePluginError(@NotNull String message) {
